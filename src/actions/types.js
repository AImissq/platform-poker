...
export const ADD_TO_SIDEPOT_ONE = 'ADD_TO_SIDEPOT_ONE';
export const ADD_TO_SIDEPOT_TWO = 'ADD_TO_SIDEPOT_TWO';
export const ADD_TO_SIDEPOT_THREE = 'ADD_TO_SIDEPOT_THREE';
